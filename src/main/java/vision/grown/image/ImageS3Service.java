...
import vision.grown.exception.ImageUploadException;
...
public class ImageS3Service{
    ...
    public FundingImage uploadFundingImage(MultipartFile image, Funding funding, int imageOrder){
        String originName = image.getOriginalFilename();
        String storedImagePath = uploadImageToS3(image);
    ...
    public ProductImage uploadProductImage(MultipartFile image, Product product, int imageOrder){
        String originName = image.getOriginalFilename();
        String storedImagePath = uploadImageToS3(image);
