...
public class ReadProductForm {
    ...
    @Builder
    public ReadProductForm(String image, String productName, String memberName, ProductType productType, LocalDate expireDate, int minPrice, int minUnit, MeasurementUnit measurementUnit) {
        this.image = image;
